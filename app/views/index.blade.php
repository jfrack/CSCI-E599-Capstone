...
@section('nav')
	...
	<a href="/employee/create" class="btn btn-primary"><strong>Add Employee</strong></a>
	<a href="/" class="btn btn-primary"><strong>Manage Forms</strong></a>
	<a href="/employee/checklists_manager" class="btn btn-primary"><strong>Manage Checklists</strong></a>
	<a href="/user/security_manager" class="btn btn-primary"><strong>System Security</strong></a>
	<a href="/user/logout" class="btn btn-warning"><strong>Logout</strong></a>
	<br><br>
@stop
